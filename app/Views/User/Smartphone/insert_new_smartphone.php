        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-10">
                            <h3 class="card-title">Insert data smartphone</h3>
                        </div>
                ...
                <div class="card-body table-responsive">
                    <div class="row mb-2">
                        <div class="col">
                            <form action="/user/tambah_smartphone" method="POST" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
