                    ...
                    <form action="" method="POST">
                        <div class="row mt-2 justify-content-between">
                            <div class="col-5">
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <a href="/user/d_m" class="btn btn-outline-danger" type="button"><span data-feather="delete"></span></a>
                                        </div>
                                    </div>
                                    <!--  -->
                                <?php } ?>
                            ...
                            <div class="offset-md-5 text-center">
                                <a href="/user/insert_new_smartphone" class="btn btn-primary btn-sm"><span data-feather="plus-square"></span> Smartphone</a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data_smartphone as $dm) { ?>
                                            <tr>
                                                ...
                                                <td><a class="font-weight-bold" href="/user/detail_smartphone/<?= $dm['slug'] ?>"><?= $dm['nama_smartphone']; ?></a></td>
                                                <td><?= $dm['merek']; ?></td>
                                                <td><?= $dm['tahun']; ?></td>
                                                <td><?= rupiah($dm['harga']); ?></td>
                                                <td><?= $dm['nama_seller'] ?></td>
                                                <td class="text-center">
                                                    <a type="button" class="btn btn-primary btn-sm" href="/user/update_smartphone/<?= $dm['slug'] ?>">Update</a>
                                                    <form action="/user/data_smartphone/<?= $dm['id']; ?>" method="POST" class="d-inline">
                                                        <?= csrf_field(); ?>
