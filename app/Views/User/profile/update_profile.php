        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <form action="/user/function_updateprofile" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" id="email" name="email" value="<?= $profile_lama['email']; ?>">
                                <div class="invalid-feedback">
