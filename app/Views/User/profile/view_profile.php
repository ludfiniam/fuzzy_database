        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="mb-3">
                        <a href="/user/update_profile" type="button" class="btn btn-primary">Update data diri</a>
                        <a href="/user/update_password" type="button" class="btn btn-outline-primary">Update password</a>
                    </div>
                </div>
            </div>
        </div>
