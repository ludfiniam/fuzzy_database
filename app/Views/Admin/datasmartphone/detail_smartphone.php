                        ...
                        <div class="col">
                            ...
                            <div class="row mb-3 justify-content-center">
                                <div class="col-5 text-center">
                                    <a href="/admin/update_smartphone/<?= $smartphone['slug']; ?>" class="btn btn-primary">Update</a>
                                    <form action="/admin/datasmartphone/<?= $smartphone['id']; ?>" method="POST" class="d-inline">
                                        <?= csrf_field(); ?>
