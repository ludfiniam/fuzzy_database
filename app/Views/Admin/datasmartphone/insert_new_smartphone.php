                            ...
                            <form action="/admin/tambah_smartphone" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="harga" class="form-control" placeholder="ex: 1250000" aria-describedby="basic-addon2" min="100000" max="100000000" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ui_os">
                                                <?php foreach ($v_ui_os as $ui_os) { ?>
                                                    <option value="<?= $ui_os['nama_ui_os'] ?>"><?= $ui_os['nama_ui_os']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ram">
                                                <?php foreach ($v_ram as $ram) { ?>
                                                    <option value="<?= $ram; ?>"><?= ($ram == 0.5) ? '512 MB' : $ram . ' GB'; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="internal">
                                                <?php foreach ($v_internal as $internal) { ?>
                                                    <option value="<?= $internal ?>"><?= $internal . ' GB'; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.01" name="tebal" class="form-control" placeholder="ex: 12.49" aria-describedby="basic-addon2" min="0.01" max="100.00" required>
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.1" name="berat" class="form-control" placeholder="ex: 12.9" aria-describedby="basic-addon2" min="0.1" max="1000.0" required>
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="body">
                                            <?php foreach ($v_body as $body) { ?>
                                                <option value="<?= $body['nama_bahan_body']; ?>"><?= $body['nama_bahan_body']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.01" name="resolusi_layar" class="form-control" placeholder="ex: 6.29" aria-describedby="basic-addon3" min="0.01" max="100.00" required>
                                            <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jenis_layar">
                                                <?php foreach ($v_jenis_layar as $jenis_layar) { ?>
                                                    <option value="<?= $jenis_layar['nama_jenis_layar']; ?>"><?= $jenis_layar['nama_jenis_layar']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jenis_protect_layar">
                                                <?php foreach ($v_protect_layar as $protect_layar) { ?>
                                                    <option value="<?= $protect_layar['nama_protect_layar']; ?>"><?= $protect_layar['nama_protect_layar']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="main_camera_tipe">
                                                <?php foreach ($v_main_camera_tipe as $main_camera_tipe) { ?>
                                                    <option value="<?= $main_camera_tipe; ?>"><?= $main_camera_tipe; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="0.1" name="resolusi_main_camera" class="form-control" placeholder="VGA = 0.5" aria-describedby="basic-addon2" min="0.0" max="100.0" required>
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="front_camera_tipe">
                                                <?php foreach ($v_front_camera_tipe as $front_camera_tipe) { ?>
                                                    <option value="<?= $front_camera_tipe; ?>"><?= $front_camera_tipe; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="0.1" name="resolusi_front_camera" class="form-control" placeholder="VGA = 0.5" aria-describedby="basic-addon2" min="0.0" max="100.0" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">MP</span>
                                                </div>
                                            </div>
                                ...
                                <div class="row mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jenis_chipset">
                                                <?php foreach ($v_jenis_chipset as $jenis_chipset) { ?>
                                                    <option value="<?= $jenis_chipset['nama_chipset']; ?>"><?= $jenis_chipset['nama_chipset']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nama_chipset" placeholder="ex: Mediatek MT6580" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="0.1" name="clock_speed_cpu" class="form-control" placeholder="ex: 1.2" aria-describedby="basic-addon3" min="0.1" max="100.00" required>
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="core_cpu">
                                                <?php foreach ($v_core_cpu as $core_cpu) { ?>
                                                    <option value="<?= $core_cpu; ?>"><?= $core_cpu; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jenis_gpu">
                                                <?php foreach ($v_jenis_gpu as $jenis_gpu) { ?>
                                                    <option value="<?= $jenis_gpu['nama_gpu']; ?>"><?= $jenis_gpu['nama_gpu']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nama_gpu" placeholder="ex : Adreno 660">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jml_sim">
                                                <?php foreach ($v_jml_sim as $jml_sim) { ?>
                                                    <option value="<?= $jml_sim; ?>"><?= $jml_sim; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipe_sim">
                                                <?php foreach ($v_tipe_sim as $tipe_sim) { ?>
                                                    <option value="<?= $tipe_sim; ?>"><?= $tipe_sim; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sim_stand">
                                                <?php foreach ($v_sim_stand as $sim_stand) { ?>
                                                    <option value="<?= $sim_stand; ?>"><?= $sim_stand; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipe_usb">
                                                <?php foreach ($v_tipe_usb as $tipe_usb) { ?>
                                                    <option value="<?= $tipe_usb['nama_usb']; ?>"><?= $tipe_usb['nama_usb']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipe_batrai">
                                                <?php foreach ($v_tipe_batrai as $tipe_batrai) { ?>
                                                    <option value="<?= $tipe_batrai; ?>"><?= $tipe_batrai; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="1" name="kapasitas_batrai" class="form-control" placeholder="ex: 6000" aria-describedby="basic-addon3" min="1" max="99999" required>
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipe_carging">
                                                <?php foreach ($v_tipe_carging as $tipe_carging) { ?>
                                                    <option value="<?= $tipe_carging; ?>"><?= $tipe_carging; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="antutu_score" min="1" max="9999999" placeholder="ex: 167623">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
