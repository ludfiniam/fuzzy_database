        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <div class="row mb-2">
                        <div class="col">
                            <form action="/admin/updatesmartphone" method="POST" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_smartphone" placeholder="Masukan nama smartphone..." value="<?= $smartphone['nama_smartphone']; ?>" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="harga" class="form-control" placeholder="ex: 1250000" aria-describedby="basic-addon2" min="100000" max="100000000" value="<?= $smartphone['harga']; ?>" required>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.01" name="tebal" class="form-control" placeholder="ex: 12.49" aria-describedby="basic-addon2" min="0.01" max="100.00" value="<?= $smartphone['tebal']; ?>" required>
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.1" name="berat" class="form-control" placeholder="ex: 12.9" aria-describedby="basic-addon2" min="0.1" max="1000.0" value="<?= $smartphone['berat']; ?>" required>
                                            <div class="input-group-append">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" step="0.01" name="resolusi_layar" class="form-control" placeholder="ex: 6.29" aria-describedby="basic-addon3" min="0.01" max="100.00" value="<?= $smartphone['resolution_layar']; ?>" required>
                                            <div class="input-group-append">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="0.1" name="resolusi_main_camera" class="form-control" placeholder="VGA = 0.5" aria-describedby="basic-addon2" min="0.0" max="100.0" value="<?= $smartphone['resolusi_main_camera']; ?>" required>
                                                <div class="input-group-append">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="0.1" name="resolusi_front_camera" class="form-control" placeholder="VGA = 0.5" aria-describedby="basic-addon2" min="0.0" max="100.0" value="<?= $smartphone['resolusi_selfie_camera']; ?>" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2">MP</span>
                                                </div>
                                            </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nama_chipset" placeholder="ex: Mediatek MT6580" value="<?= $smartphone['nama_chipset']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="0.1" name="clock_speed_cpu" class="form-control" placeholder="ex: 1.2" aria-describedby="basic-addon3" min="0.1" max="100.00" value="<?= $smartphone['clock_speed_cpu']; ?>" required>
                                                <div class="input-group-append">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nama_gpu" value="<?= $smartphone['nama_lengkap_gpu']; ?>" placeholder="ex : Adreno 660">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" step="1" name="kapasitas_batrai" class="form-control" placeholder="ex: 6000" aria-describedby="basic-addon3" min="1" max="99999" value="<?= $smartphone['kapasitas_batrai']; ?>" required>
                                                <div class="input-group-append">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="antutu_score" min="1" max="9999999" placeholder="ex: 167623" value="<?= $smartphone['test_antutu']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
