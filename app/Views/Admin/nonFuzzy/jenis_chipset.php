        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <div class="row mb-3">
                        <div class="col-12">
                            <form action="/admin/add_chipset" method="post">
                                <label for="tambahahkan">tambahkan jenis chipset processor</label>
            ...
            <div class="card">
                ...
                <div class="col-12 card-body mt-2">
                    <form action="" method="POST">
                        ...
                        <div class="row mt-2 justify-content-between">
                            <div class="col-5">
                                <?php if (session()->get('key_chipset') == null) { ?>
                                    <!-- sebelum input search -->
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="key_chipset" placeholder="Masukan pencarian...">
                                ...
                                <?php } else { ?>
                                    <!-- sesudah search -->
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="key_chipset" placeholder="<?= session()->get('key_chipset'); ?>" disabled>
                                        <div class="input-group-append">
                                            <a href="/admin/d_chipset" class="btn btn-outline-danger" type="button"><span data-feather="delete"></span></a>
                                        </div>
                                    </div>
                                    <!--  -->
                                <?php } ?>
                ...
                <div class="card-body table-responsive">
                    <div class="container">
                                ...
                                <table class="table table-striped" id="table" data-toggle="table" data-height="460" data-pagination="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center align-center">Jenis Chipset Processor</th>
                                        ...
                                        foreach ($data_non_fuzzy as $dm) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center align-center">
                                                    <form action="/admin/update_chipset" method="post">
                                                        <?= csrf_field(); ?>
                                                        <input type="hidden" name="id" value="<?= $dm['id']; ?>">
                                                        <input class="form-control form-control-sm text-center" type="text" name="nama_chipset" id="nama_chipset_<?= $a; ?>" value="<?= $dm['nama_chipset']; ?>" disabled required>
                                                        <input type="hidden" name="nama_chipset_lama" value="<?= $dm['nama_chipset']; ?>">
                                                </td>
                                                <td class="text-center align-center">
                                                    ...
                                                    <form action="/admin/jenis_chipset/<?= $dm['id']; ?>" method="POST" class="d-inline">
                                                        <?= csrf_field(); ?>
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <input type="hidden" name="nama_chipset_lama" value="<?= $dm['nama_chipset']; ?>">
                                                        <input type="hidden" name="id" value="<?= $dm['id']; ?>">
                                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus chipset processor <?= $dm['nama_chipset']; ?>')">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php
                        ...
                        <div class="row">
                            <?= $pager->links('t_jenis_chipset', 'smartphone') ?>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
...
<script>
    function disable(a) {
        document.getElementById('nama_chipset_' + a).disabled = true;
        document.getElementById('submit_' + a).disabled = true;
    }

    function undisable(a) {
        document.getElementById('nama_chipset_' + a).disabled = false;
