        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <div class="row mb-3">
                        <div class="col-12">
                            <form action="/admin/add_protect_layar" method="post">
                                <label for="tambahahkan">tambahkan jenis protect layar</label>
            ...
            <div class="card">
                ...
                <div class="col-12 card-body mt-2">
                    <form action="" method="POST">
                        ...
                        <div class="row mt-2 justify-content-between">
                            <div class="col-5">
                                <?php if (session()->get('key_protect_layar') == null) { ?>
                                    <!-- sebelum input search -->
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="key_protect_layar" placeholder="Masukan pencarian...">
                                ...
                                <?php } else { ?>
                                    <!-- sesudah search -->
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="key_protect_layar" placeholder="<?= session()->get('key_protect_layar'); ?>" disabled>
                                        <div class="input-group-append">
                                            <a href="/admin/d_protect_layar" class="btn btn-outline-danger" type="button"><span data-feather="delete"></span></a>
                                        </div>
                                    </div>
                                    <!--  -->
                                <?php } ?>
                ...
                <div class="card-body table-responsive">
                    <div class="container">
                                ...
                                <table class="table table-striped" id="table" data-toggle="table" data-height="460" data-pagination="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center align-center">Jenis Protect Layar</th>
                                        ...
                                        foreach ($data_non_fuzzy as $dm) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center align-center">
                                                    <form action="/admin/update_protect_layar" method="post">
                                                        <?= csrf_field(); ?>
                                                        <input type="hidden" name="id" value="<?= $dm['id']; ?>">
                                                        <input class="form-control form-control-sm text-center" type="text" name="nama_protect_layar" id="nama_protect_layar_<?= $a; ?>" value="<?= $dm['nama_protect_layar']; ?>" disabled required>
                                                        <input type="hidden" name="nama_protect_layar_lama" value="<?= $dm['nama_protect_layar']; ?>">
                                                </td>
                                                <td class="text-center align-center">
                                                    ...
                                                    <form action="/admin/jenis_protect_layar/<?= $dm['id']; ?>" method="POST" class="d-inline">
                                                        <?= csrf_field(); ?>
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <input type="hidden" name="nama_protect_layar_lama" value="<?= $dm['nama_protect_layar']; ?>">
                                                        <input type="hidden" name="id" value="<?= $dm['id']; ?>">
                                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus protect layar <?= $dm['nama_protect_layar']; ?>')">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        <?php
                        ...
                        <div class="row">
                            <?= $pager->links('t_jenis_protect_layar', 'smartphone') ?>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
...
<script>
    function disable(a) {
        document.getElementById('nama_protect_layar_' + a).disabled = true;
        document.getElementById('submit_' + a).disabled = true;
    }

    function undisable(a) {
        document.getElementById('nama_protect_layar_' + a).disabled = false;
