...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="/admin"><span data-feather="truck"></span> Smartphoneku</a>
                        ...
                        <div class="dropdown">
                            <li class="nav-item">
                                ...
                                <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="/admin/keanggotaan_speed_cpu"><span data-feather="slack"></span> Clock Speed CPU</a>
                                    ...
                                    <a class="dropdown-item" href="/admin/keanggotaan_resolusi_main_camera"><span data-feather="camera"></span> Resolusi Main Camera</a>
                                    <a class="dropdown-item" href="/admin/keanggotaan_batrai"><span data-feather="battery-charging"></span> Kapasitas Batrai</a>
                                    <a class="dropdown-item" href="/admin/keanggotaan_test_antutu"><span data-feather="bar-chart-2"></span> Score Antutu</a>
                                </div>
                            </li>
                        </div>
                    </ul>
